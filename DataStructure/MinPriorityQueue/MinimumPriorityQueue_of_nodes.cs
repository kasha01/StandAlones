...
namespace DataStructure.MinPriorityQueue
{
	class Node
	{
		...
		public int data; public int priority;
		public Node(int d, int p)
		{
			this.data = d; this.priority = p;
		}
		public static bool operator <(Node n1, Node n2) { return n1.priority < n2.priority; }
		public static bool operator >(Node n1, Node n2) { return n1.priority > n2.priority; }
		public static bool operator <=(Node n1, Node n2) { return n1.priority <= n2.priority; }
		public static bool operator >=(Node n1, Node n2) { return n1.priority >= n2.priority; }
	}

	public class MinPriorityQueue_of_nodes
	{
		...
		public void add_with_priority(int d, int p)
		{
		...
		public void decrease_priority(int value, int newP)
		{
		...
		public int extract_min()
		{
			...
			//get the top
			Node n = arr[0];            //extract the minimum node (top of heap)
